package tjw.ramdan.domain.base
...
import tjw.ramdan.R
import tjw.ramdan.extentions.cHideSoftKeyboard
import tjw.ramdan.extentions.inTransaction
import tjw.ramdan.extentions.observe

abstract class BaseActivity<B : ViewDataBinding> : AppCompatActivity() {
    abstract fun layoutId(): Int
    lateinit var binding: B
    private val fragHolderId = R.id.frag
